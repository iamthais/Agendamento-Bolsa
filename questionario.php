...
<div class="container">
    ...
    <div class="row mt-5 mb-5 justify-content-center text-center">
        ...
        <div class="col-12">
            ...
            <input class="form-check-input" type="radio" name="check3" value="1" id="flexCheckDefault" onchange="exibeCampo3(this)">
            <label class="form-check-label" for="flexCheckDefault">
                SIM
            </label>
            <input class="form-check-input" type="radio" name="check3" value="0" id="flexCheckDefault" onchange="exibeCampo3(this)">
            <label class="form-check-label" for="flexCheckDefault">
                NÃO
            </label>
            <br>
        ...
        <div class="col-12">
            ...
            <input class="form-check-input" type="radio" name="check4" value="1" id="flexCheckDefault" onchange="exibeCampo4(this)">
            <label class="form-check-label" for="flexCheckDefault">
                SIM
            </label>
            <input class="form-check-input" type="radio" name="check4" value="0" id="flexCheckDefault" onchange="exibeCampo4(this)">
            <label class="form-check-label" for="flexCheckDefault">
                NÃO
            </label>
            <br>
        ...
        <div class="col-12">
            ...
            <input class="form-check-input" type="radio" name="check5" value="1" id="flexCheckDefault" onchange="exibeCampo5(this)">
            <label class="form-check-label" for="flexCheckDefault">
                SIM
            </label>
            <input class="form-check-input" type="radio" name="check5" value="0" id="flexCheckDefault" onchange="exibeCampo5(this)">
            <label class="form-check-label" for="flexCheckDefault">
                NÃO
            </label>
            <br>
